...
/**
 * Interface implemented by enhancers that are applied before page/section/element method call.
 *
 * @see BeforeMethodPriority
 */
public interface BeforeMethodEnhancer extends Enhancer {
    /**
     * Determine whether the enhancer can be applied by a specific class, before a specific method or
